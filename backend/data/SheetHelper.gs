...
function _initCauHinhDefaults() {
  ...
  const defaults = [
    ...
    ['kiem_tra_dia_ban',         'TRUE',             'Bật kiểm tra địa bàn làm việc khi chấm công kèm GPS (TRUE/khác)'],
    ['dia_ban_cho_phep',         '{"quan":["1","3","5","8","10","11","Phú Nhuận","Bình Thạnh"],"khuVuc":["Bến Cát"],"loaiTru":["Văn Thố","Bàu Bàng"]}', 'Địa bàn cho phép chấm công GPS (JSON: quan/khuVuc/loaiTru)'],
    ['geocode_email',            'admin@cscc.vn',    'Email liên hệ gửi kèm yêu cầu Nominatim (theo policy OSM)'],
